...
RBAN_HANDLER = CommandHandler("rban", rban, pass_args=True, filters=filters=CustomFilters.sudo_filter | CustomFilters.support_filter)
RUNBAN_HANDLER = CommandHandler("runban", runban, pass_args=True, filters=filters=CustomFilters.sudo_filter | CustomFilters.support_filter)
